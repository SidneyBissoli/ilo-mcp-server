...
export const SERVER_CONFIG = {
  ...
  instructions:
    ...
    "country, year and disaggregations such as sex and age. Typical flow: search_indicators " +
    "to find a dataflow, then get_data with country and period filters; use " +
    "get_indicator_metadata / list_dimension_values to discover valid filter codes. " +
